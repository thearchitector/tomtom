...
The goal of the plan is to produce a set of discrete tasks. Your process SHOULD be:
...
Description of the approach to the work and the changes that must be made.
